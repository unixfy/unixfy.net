...
<div class="bg-[#7E1F86] text-white section">
    <div class="ct">
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-4 grid-rows-8 md:grid-rows-2 gap-6">
            <svg viewBox="0 0 128 128" height="50px" width="50px" class="inline pr-2">
                <title>Svelte</title>
            ...
            <svg viewBox="0 0 128 128" height="50px" width="50px" class="inline pr-2">
                <title>Django</title>
                <path fill="#003A2B"
                      d="M126.5 83.8c0 3.8-3.1 6.9-6.9 6.9H8.4c-3.8 0-6.9-3.1-6.9-6.9V44.2c0-3.8 3.1-6.9 6.9-6.9h111.2c3.8 0 6.9 3.1 6.9 6.9v39.6z"></path>
                <path fill="#fff"
